...
def start(update, context):
    ...
    if squr ==[]:
      ...
      cur.execute("SELECT j.* , (select count(l.lead_id) from leaddata l where l.job_id = j.job_id) as counter FROM jobs j where date between '2023-05-12' and '2023-05-13'")
      jobs=cur.fetchall()
      yourjob = []
      for y in jobs:
